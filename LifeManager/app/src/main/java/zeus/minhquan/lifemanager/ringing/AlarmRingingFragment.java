...
public class AlarmRingingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (android.os.Build.VERSION.SDK_INT <= Build.VERSION_CODES.JELLY_BEAN) {
            ...
            timeField.setText(DateTimeUtils.getUserTimeString(getContext(), mAlarm.getTimeHour(), mAlarm.getTimeMinute()));
        }

        TextView dateField = (TextView) view.findViewById(R.id.alarm_ringing_date);
        dateField.setText(DateTimeUtils.getFullDateStringForNow());
